...
def prepare_plotfolder(run_name,run_number):
    ...
    path_hist = '{}/histogram'.format(path)
    path_spectra = '{}/spectra'.format(path)
    path_quadrant = '{}/quadrant_analysis'.format(path)
    path_quadrant_jpdf = '{}/quadrant_analysis/jpdf'.format(path)    
    path_quadrant_scatter = '{}/quadrant_analysis/scatter'.format(path)    
    ...
    if os.path.exists(path):
        ...
        try:
            ...
            os.mkdir(path_quadrant)
            os.mkdir(path_quadrant_jpdf)
            os.mkdir(path_quadrant_scatter)
            os.mkdir(path_times)
            os.mkdir(path_hist)
